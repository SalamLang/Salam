...
% ---------------------------------------------------------------------
%  Build:
%     xelatex book.tex     % first pass
%     xelatex book.tex     % second pass (ToC + references)
% =====================================================================
...
\newfontfamily\farsifont[Path=./../../fonts/, Extension=.ttf, Script=Arabic,
  BoldFont={XB RoyaBd}, ItalicFont={XB RoyaIt}, BoldItalicFont={XB RoyaBdIt},
  Scale=1.0]{XB Roya}
...
\newcommand{\salamcodeENfont}{\salamcodefont}
\newcommand{\salamcodeFAfont}{\salamcodefontfa}
...
\hypersetup{
  ...
  % title/copyright pages precede \frontmatter, so their arabic page numbers
  % would clash with \mainmatter's; unique internal anchor names stop
  % xdvipdfmx reporting "@page.N already defined".
  hypertexnames=false,
}
...
\input{chapters/00-contributors}
...
\input{chapters/04-control-flow}
\input{chapters/05-loops}
\input{chapters/06-functions}
\input{chapters/07-arrays-vectors}
\input{chapters/08-strings}
\input{chapters/09-structs-methods}
\input{chapters/10-enums-matching}
\input{chapters/11-interfaces}
\input{chapters/12-generics}
\input{chapters/13-closures-lambdas}
\input{chapters/14-error-defer}
\input{chapters/15-modules-packages}
\input{chapters/16-stdlib-1}
\input{chapters/17-stdlib-2}
\input{chapters/18-memory}
\input{chapters/19-ffi}
\input{chapters/20-concurrency}
\input{chapters/21-testing-debugging}
\input{chapters/22-bilingual}
\input{chapters/23-advanced}

\appendix
\input{chapters/appendix-a-keywords}
\input{chapters/appendix-b-grammar}
\input{chapters/appendix-c-cheatsheet}
\input{chapters/appendix-d-solutions}
