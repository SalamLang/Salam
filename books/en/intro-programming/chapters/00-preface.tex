...
English. Its keywords are English words \code{if}, \code{until},
...
is spelled \code{until} in one and \fa{تاوقتی} in the other; a function is
...
\code{tests/en/}). They are not pseudo-code; they compile and run.
\end{note}
