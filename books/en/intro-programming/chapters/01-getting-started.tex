...
write in a new language is one that displays the words ``Hello, World!''. Let us % chktex 38
...
func main:
\end{salam}
This line says: ``define a \textbf{function} named \textbf{main}.'' A function is % chktex 38
...
\exercise Write ``Hello, World!'' once in English and once in Persian, and run % chktex 38
