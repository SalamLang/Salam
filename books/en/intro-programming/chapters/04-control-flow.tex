...
for \code{if}, \code{\fa{وگرنه}} for \code{else}, and \code{\fa{پایان}} for
\code{end}:
...
An \code{else if} chain is written by combining \code{\fa{وگرنه}} and
\code{\fa{اگر}}, exactly as in English.
...
\exercise Write a function \code{sign(n i32) str} that returns \code{"negative"},
