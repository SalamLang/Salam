...
\code{int}, not a \code{str}. To attach a number, convert it first the
...
func main:
    letter : char = 'S'
    println letter              // S
    println letter as int       // 83, the code for 'S'
...
func main:
    ...
    back : auto = str.ToInt("42")           // 42, an int
    println back + 8                      // 50
end
\end{salamen}
...
back into an \code{int}. With \code{FromInt} you can finally use \code{+} to
...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item \begin{sloppypar}
        \code{str} provides \code{Upper}, \code{Lower}, \code{Trim},
