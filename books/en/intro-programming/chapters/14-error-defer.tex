...
\begin{salam}
func index_of(values i32[5], target i32) i32:
...
func safe_divide(a i32, b i32) option.Option<i32>:
    if b == 0:
...
\exercise Write a function \code{find\_first\_negative(a i32[5]) i32} that returns
