...
\begin{salamen}
func main:
    mut prices : HashMap<str, int> = HashMap {}
...
func main:
    ...
    mut counts : HashMap<str, int> = HashMap {}
...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item \begin{sloppypar}
        \code{Stack<T>} (push/pop/peek) is last-in, first-out;
...
\exercise Build a \code{HashMap<str, int>} of three people's ages, then look up and
