...
variables --- the \code{i32}s, the \code{bool}s, the fixed-size arrays and structs.
...
\begin{itemize}[leftmargin=1.4em]
  \item \textbf{Scalars} --- \code{i32}, \code{f64}, \code{bool}, \code{char}, an
...
other growable collections. The fixed-size array \code{i32[5]}, by contrast, needs
...
\exercise Explain in a comment why a fixed array \code{i32[10]} needs no
\code{free} but a \code{Vector<i32>} does.
