...
\begin{salam}
func average(a i32[3]) f64:
    mut sum i32 = 0
    for mut i = 0; i < 3; i = i + 1:
        sum += a[i]
        println "after adding", a[i], "sum is", sum    // a temporary probe
    end
    ret (sum as f64) / 3.0
end
...
\exercise Write a function \code{factorial(n i32) i32} and a \code{test\_factorial}
