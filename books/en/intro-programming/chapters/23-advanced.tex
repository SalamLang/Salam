...
who is often you, months later. Salam even ships a formatter, \code{salam format},
...
\begin{tip}
Run \code{salam format} before you save or share code, and let it settle every
...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item \textbf{Literals are \code{int}.} Storing one in a smaller or unsigned type
...
\code{salam format} on it, rename anything unclear, and add a comment explaining one
