...
\code{f32}, \code{f64} & \code{\fa{اعشاری۳۲}}, \code{\fa{اعشاری۶۴}} & floating-point \\
...
\noindent The aliases \code{int} ($=$ \code{i32}), \code{uint} ($=$ \code{u32}),
and \code{float} ($=$ \code{f32}) are also accepted. Note that the digits inside
