...
y i32 = 250                // i32 by default
b u8 = 250 as i32 as u8    // explicit conversion with 'as'
\end{salam}

\noindent Types: \code{i8 i16 i32 i64}, \code{u8 u16 u32 u64}, \code{f32 f64},
\code{bool}, \code{char}, \code{str}. \\
...
\begin{salam}
while cond:           ... end
for mut i = 0; i < n; i = i + 1:   ... end
repeat 3:             ... end          // 3 times
repeat 1 to 5:        ... end          // 1..5 inclusive
repeat 0 to 20 every 2:   ... end      // step by 2
...
\begin{salam}
a i32[3] = [1, 2, 3]            // fixed array, indexed 0..2
g i32[2][3] = [[1,2,3],[4,5,6]] // 2-D
...
apply((x i32) => x + 1, 5)            // lambda as argument
func make_adder(n i32) func(i32) i32:
    ret (x i32) => x + n               // closure capturing n
end
\end{salam}
...
\begin{salam}
func withdraw(n i32) bool: ... end    // bool success flag
