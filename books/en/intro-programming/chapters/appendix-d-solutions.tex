...
func turn_right(d Direction) Direction:
    ...
    else if d == Direction.East: ret Direction.South
    else if d == Direction.South: ret Direction.West
...
func main:
    ...
    d = turn_right(d)
    println "now facing index:", d as i32      // East = 1
end
\end{salam}
...
\begin{salam}
func find_first_negative(a i32[5]) i32:
...
\begin{salam}
func main:
    mut ages HashMap<str, i32> = HashMap {}
    ages.insert("Sara", 30)
    ages.insert("Ali", 25)
    ages.insert("Mina", 41)
