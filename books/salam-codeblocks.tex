% =====================================================================
%  salam-codeblocks.tex  -  shared code-block machinery for ALL books
% ---------------------------------------------------------------------
%  This file is \input by English and Persian Latex books
%
%    • English / shell Salam code  ->  listings card (LTR, full colour
%      highlighting: keywords, types, numbers, strings, comments).
%    • Persian Salam code          ->  a custom fancyvrb renderer (RTL,
%      right-aligned, automatic indentation, line numbers OUTSIDE the
%      card in the margin) with the SAME colour highlighting, including
%      keywords, types, numbers, strings and nested /* */ comments
%      something the listings package cannot do for Persian letters.
%
% =====================================================================
