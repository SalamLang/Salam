...
for language in languages:
    ...
    if isinstance(language["code"], str):
        language["code"] = language["code"].lower().strip().split(", ")
    else:
        for i in range(len(language["code"])):
            language["code"][i] = language["code"][i].lower().strip()
