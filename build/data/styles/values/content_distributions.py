...
content_distributions = [
    ...
    .add_text(Lang.languages["EN"]["code"], "space-between")
    .add_text(Lang.languages["FA"]["code"], "فضا-بین"),
    Value()
    .set_generate_name("space-around")
    .add_text(Lang.languages["EN"]["code"], "space-around")
    .add_text(Lang.languages["FA"]["code"], "فضا-دور"),
    Value()
    .set_generate_name("space-evenly")
    .add_text(Lang.languages["EN"]["code"], "space-evenly")
    .add_text(Lang.languages["FA"]["code"], "فضا-یکسان"),
    Value()
    .set_generate_name("stretch")
    .add_text(Lang.languages["EN"]["code"], "stretch")
    .add_text(Lang.languages["FA"]["code"], "کشیدن"),
]
...
if __name__ == "__main__":
    ...
    content_distributions_dict = {
        ...
        for value in content_distributions
