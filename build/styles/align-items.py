...
if __name__ == "__main__":
    ...
    property.add_text(
        Lang.languages["EN"]["code"], "animation-timing-function"
    )  # Adjusted for Lang dictionary
    property.add_text(
        Lang.languages["FA"]["code"], "تابع زمان انیمیشن"
    )  # Adjusted for Lang dictionary
    property.set_type(
        PropertyType.String
    )  # Adjusted to use PropertyType instead of Type
