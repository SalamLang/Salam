...
if __name__ == "__main__":
    ...
    property.add_reserve_values(
        [
            ...
            .add_text(Lang.FA, "هیچ"),
            Value()
            .set_generate_name("block")
            .add_text(Lang.EN, "block")
            .add_text(Lang.FA, "بلوک"),
            Value()
            .set_generate_name("inline")
            .add_text(Lang.EN, "inline")
            .add_text(Lang.FA, "داخلی"),
            Value()
            .set_generate_name("inline-block")
            .add_text(Lang.EN, "inline-block")
            .add_text(Lang.FA, "داخلی-بلوک"),
            Value()
            .set_generate_name("flex")
            .add_text(Lang.EN, "flex")
            .add_text(Lang.FA, "فلکس"),
            Value()
            .set_generate_name("grid")
            .add_text(Lang.EN, "grid")
            .add_text(Lang.FA, "گرید"),
            Value()
            .set_generate_name("table")
            .add_text(Lang.EN, "table")
            .add_text(Lang.FA, "جدول"),
        ]
    )
