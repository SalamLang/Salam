...
if __name__ == "__main__":
    ...
    element.add_attribute() \
        ...
        .set_type(Type.Url) \
        .add_text(Lang.EN, "action") \
        .add_text(Lang.FA, "منبع") \

    element.add_attribute() \
        .set_generate_name("autocomplete") \
        .set_type(Type.Boolean) \
        .add_text(Lang.EN, "autocomplete") \
        .add_text(Lang.FA, "پر کردن خودکار") \

    element.add_attribute() \
        .set_generate_name("enctype") \
        .set_type(Type.String) \
        .add_text(Lang.EN, "enctype") \
        .add_text(Lang.FA, "انک تایپ") \
        .add_reserve_values(mediatypes.mediatypes) \

    element.add_attribute() \
        .set_generate_name("method") \
        .set_type(Type.String) \
    ...
    element.add_attribute() \
        .set_generate_name("novalidate") \
        .set_type(Type.Boolean) \
        .add_text(Lang.EN, "novalidate") \
        .add_text(Lang.FA, "بدون اعتبارسنجی") \

    element.add_attribute() \
        .set_generate_name("rel") \
        .set_type(Type.String) \
        .add_text(Lang.EN, "rel") \
        .add_text(Lang.FA, "ریلیشن") \
