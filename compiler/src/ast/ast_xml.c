...
static void ast_emit_value(xml_writer_t *w, const token_value_t *v)
{
    ...
    case TV_STRING:
        xml_open(w, "value");
        xml_attr(w, "kind", "string");
        xml_text(w, v->as.s ? v->as.s : "");
        xml_close(w);
        break;
    case TV_CHAR:
        xml_open(w, "value");
        xml_attr(w, "kind", "char");
        sal_u64toa((uint64_t)v->as.i, buf);
        xml_text(w, buf);
        xml_close(w);
        break;
...
void ast_to_xml(xml_writer_t *w, const ast_node_t *n)
{
    ...
    switch (n->kind) {
    case AST_PROGRAM:
        ast_child_list(w, "defs", &n->list);
        break;
    case AST_TYPE_ALIAS:
        ast_child(w, "type", n->type);
        break;
    case AST_CONST_DECL:
        ast_child(w, "type", n->type);
    ...
    case AST_PARAM:
        ast_child(w, "type", n->type);
        ast_child(w, "default", n->a);
        break;
    case AST_STRUCT_DEF:
        ast_child_list(w, "members", &n->list);
        break;
    case AST_INTERFACE_DEF:
        ast_child_list(w, "methods", &n->list);
        break;
    case AST_FIELD:
        ast_child(w, "type", n->type);
        ast_child(w, "default", n->a);
    ...
    case AST_ENUM_MEMBER:
        ...
        break;
    case AST_BLOCK:
        ast_child_list(w, "statements", &n->list);
        break;
    case AST_VAR_DECL:
        ast_child(w, "type", n->type);
        ...
        break;
    case AST_ASSIGN:
        ast_child(w, "target", n->a);
        ast_child(w, "value", n->b);
        break;
    case AST_IF:
    ...
    case AST_UNTIL:
        ...
        break;
    case AST_REPEAT:
        ast_child(w, n->c ? "from" : "count", n->a);
        ast_child(w, "to", n->c);
        ast_child(w, "step", n->d);
        ast_child(w, "body", n->b);
        break;
    case AST_FOR:
        ast_child(w, "init", n->a);
    ...
    case AST_RETURN:
        ...
        break;
    case AST_DEFER:
        ast_child(w, "statement", n->a);
        break;
    case AST_EXPR_STMT:
        ast_child(w, "expr", n->a);
        break;
    case AST_BINARY:
        ast_child(w, "left", n->a);
    ...
    case AST_CAST:
        ...
        break;
    case AST_CALL:
        ast_child(w, "callee", n->a);
        ast_child_list(w, "args", &n->list);
        break;
    case AST_MEMBER:
    ...
    case AST_ARRAY_LIT:
        ...
        break;
    case AST_STRUCT_LIT:
        ast_child_list(w, "fields", &n->list);
        break;
    case AST_FIELD_INIT:
        ast_child(w, "value", n->a);
        break;
    case AST_TYPE:
        if (n->dims.len) ast_child_list(w, "dims", &n->dims);
        break;
    case AST_LAYOUT_BLOCK:
        ast_child_list(w, "items", &n->list);
        break;
    case AST_LAYOUT_ELEMENT:
        ast_child_list(w, "children", &n->list);
        break;
    case AST_LAYOUT_ATTR:
        ast_child(w, "value", n->a);
        break;
