...
SAL_INLINE value_t val_int(int64_t x)    { value_t v; v.kind = VAL_INT;   v.as.i = x; return v; }

SAL_INLINE value_t val_char(int64_t x)   { value_t v; v.kind = VAL_CHAR;  v.as.i = x; return v; }

SAL_INLINE value_t val_float(double x)   { value_t v; v.kind = VAL_FLOAT; v.as.f = x; return v; }

SAL_INLINE value_t val_bool(bool x)      { value_t v; v.kind = VAL_BOOL;  v.as.b = x; return v; }

SAL_INLINE value_t val_str(const char *s){ value_t v; v.kind = VAL_STR;   v.as.s = s ? s : ""; return v; }

SAL_INLINE value_t val_module(struct module *m){ value_t v; v.kind = VAL_MODULE; v.as.mod = m; return v; }
