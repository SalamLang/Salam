...
#define LOG_T_AT(lg, ph, file, span, ...)                                                \
    logger_log((lg), (ph), LOG_TRACE, (file), &(span), __VA_ARGS__)

#define LOG_D_AT(lg, ph, file, span, ...)                                                \
    logger_log((lg), (ph), LOG_DEBUG, (file), &(span), __VA_ARGS__)

#define LOG_W_AT(lg, ph, file, span, ...)                                                \
    logger_log((lg), (ph), LOG_WARN, (file), &(span), __VA_ARGS__)
