...
- `src/examples_data.salam` - the example programs (en/fa/ar), generated by
  `compiler/tools/salam/gen-examples.salam` from `compiler/tests/*/editor-selected/`.
...
```sh
salam exec compiler/tests/fa/types/struct.salam --lang=fa
salam run  --interp compiler/tests/en/apps/brainfuck.salam
```
