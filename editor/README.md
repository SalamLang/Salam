...
- `src/examples_data.salam` - the example programs (en/fa/ar), generated by
  `compiler/tools/salam/gen-examples.salam` from `compiler/tests/*/examples/editor-selected/`.
...
```sh
salam exec compiler/tests/fa/examples/types/struct.salam --lang=fa
salam run  --interp compiler/tests/en/examples/apps/brainfuck.salam
```
