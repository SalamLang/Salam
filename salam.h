...
void parser_layout_element_attributes(parser_t* parser, ast_layout_type_t type, ast_layout_node_t* element, bool acceptAttrs, bool acceptStyles, bool acceptHoverStyles, bool acceptChildren, bool isHoverStyles);
