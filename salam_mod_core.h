...
extern SALAM_PURE int32_t strcmp(const char* a, const char* b);
extern SALAM_PURE const char* strstr(const char* haystack, const char* needle);
extern int64_t strtol(const char* s, void* endptr, int32_t base);
extern double strtod(const char* s, void* endptr);
extern SALAM_PURE uint64_t strlen(const char* s);
