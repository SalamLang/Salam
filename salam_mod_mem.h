...
extern void* memmove(void* dst, void* src, uint64_t n);

extern const uint64_t HDR__SIZE;
extern int64_t __md__allocs;
extern int64_t __md__frees;
extern int64_t __md__live;
extern int64_t __md__peak;
