...
static inline void _Salam_g_S_Vector__i32_set_i32_i32(Vector__i32* this, int32_t i, int32_t x);
#endif
...
static inline void _Salam_g_S_Vector__i32_insert_i32_i32(Vector__i32* this, int32_t i, int32_t x);
#endif
...
static inline int32_t _Salam_g_S_Vector__i32_operator__index_i32(Vector__i32* this, int32_t i);
#endif
...
static inline void _Salam_g_S_Vector__i32_operator__index__set_i32_i32(Vector__i32* this, int32_t i, int32_t x);
#endif
...
static inline void _Salam_g___insertion__range__i32_Vector__i32_i32_i32(Vector__i32 v, int32_t lo, int32_t hi);
#endif
...
static inline void _Salam_g_S_Vector__i64_set_i32_i64(Vector__i64* this, int32_t i, int64_t x);
#endif
...
static inline void _Salam_g_S_Vector__i64_insert_i32_i64(Vector__i64* this, int32_t i, int64_t x);
#endif
...
static inline int64_t _Salam_g_S_Vector__i64_operator__index_i32(Vector__i64* this, int32_t i);
#endif
...
static inline void _Salam_g_S_Vector__i64_operator__index__set_i32_i64(Vector__i64* this, int32_t i, int64_t x);
#endif
...
static inline void _Salam_g_S_Vector__i32_reserve_i32(Vector__i32* this, int32_t need) {
    ...
    this->data = ((int32_t*)(_Salam_mem_Reallocate_void_ptr_u64(((void*)(this->data)), (((uint64_t)(c)) * (uint64_t)sizeof(int32_t)))));
    this->__cap = c;
}
...
static inline int32_t* _Salam_g_S_Vector__i32_get_i32(Vector__i32* this, int32_t i) {
    ...
    return ((int32_t*)(intptr_t)((((int64_t)(intptr_t)(this->data)) + (((int64_t)(i)) * ((int64_t)((uint64_t)sizeof(int32_t)))))));
}
        ...
        while (go) {
            if ((j < lo)) {
                ...
                if ((key < _Salam_g_S_Vector__i32_get_i32(&(v), j)[0])) {
                    _Salam_g_S_Vector__i32_set_i32_i32(&(v), (j + 1), _Salam_g_S_Vector__i32_get_i32(&(v), j)[0]);
                    j -= 1;
                } else {
                    go = false;
                }
...
static inline void _Salam_g_S_Vector__i64_reserve_i32(Vector__i64* this, int32_t need) {
    ...
    this->data = ((int64_t*)(_Salam_mem_Reallocate_void_ptr_u64(((void*)(this->data)), (((uint64_t)(c)) * (uint64_t)sizeof(int64_t)))));
    this->__cap = c;
}
...
static inline int64_t* _Salam_g_S_Vector__i64_get_i32(Vector__i64* this, int32_t i) {
    ...
    return ((int64_t*)(intptr_t)((((int64_t)(intptr_t)(this->data)) + (((int64_t)(i)) * ((int64_t)((uint64_t)sizeof(int64_t)))))));
}
