...
double _Salam_stats_Sum_Vector__f64(Vector__f64 v) {
    double s = 0.0;
    for (int64_t __rep1 = 0, __repn1 = (int64_t)(_Salam_g_S_Vector__f64_len(&(v))); __rep1 < __repn1; __rep1++) {
...
double _Salam_stats_Mean_Vector__f64(Vector__f64 v) {
    ...
    return (_Salam_stats_Sum_Vector__f64(v) / ((double)(_Salam_g_S_Vector__f64_len(&(v)))));
}
...
double _Salam_stats_Min_Vector__f64(Vector__f64 v) {
    ...
    for (int64_t __rep2 = 0, __repn2 = (int64_t)(_Salam_g_S_Vector__f64_len(&(v))); __rep2 < __repn2; __rep2++) {
...
double _Salam_stats_Max_Vector__f64(Vector__f64 v) {
    ...
    double m = _Salam_g_S_Vector__f64_get_i32(&(v), 0)[0];
    for (int64_t __rep3 = 0, __repn3 = (int64_t)(_Salam_g_S_Vector__f64_len(&(v))); __rep3 < __repn3; __rep3++) {
...
void _Salam_stats___sorted_Vector__f64(Vector__f64 v, Vector__f64* __ret) {
    Vector__f64 c = ({ Vector__f64 __s4; _Salam_g_clone__f64_Vector__f64(v, &__s4); __s4; });
...
double _Salam_stats_Median_Vector__f64(Vector__f64 v) {
    ...
    Vector__f64 c = ({ Vector__f64 __s5; _Salam_stats___sorted_Vector__f64(v, &__s5); __s5; });
    double m = 0.0;
    if (((n % 2) == 1)) {
        m = _Salam_g_S_Vector__f64_get_i32(&(c), (n / 2))[0];
    } else {
        m = ((_Salam_g_S_Vector__f64_get_i32(&(c), ((n / 2) - 1))[0] + _Salam_g_S_Vector__f64_get_i32(&(c), (n / 2))[0]) / 2.0);
    }
...
double _Salam_stats_Percentile_Vector__f64_f64(Vector__f64 v, double p) {
    ...
    Vector__f64 c = ({ Vector__f64 __s8; _Salam_stats___sorted_Vector__f64(v, &__s8); __s8; });
    double q = p;
    if ((q < 0.0)) {
        q = 0.0;
    }
    ...
    const double out = (_Salam_g_S_Vector__f64_get_i32(&(c), lo)[0] + ((_Salam_g_S_Vector__f64_get_i32(&(c), hi)[0] - _Salam_g_S_Vector__f64_get_i32(&(c), lo)[0]) * frac));
    _Salam_g_S_Vector__f64_free(&(c));
    return out;
    _Salam_g_S_Vector__f64_free(&(c));
}
