...
static inline void _Salam_g_S_Vector__f64_set_i32_f64(Vector__f64* this, int32_t i, double x);
#endif
...
static inline void _Salam_g_S_Vector__f64_insert_i32_f64(Vector__f64* this, int32_t i, double x);
#endif
...
static inline double _Salam_g_S_Vector__f64_operator__index_i32(Vector__f64* this, int32_t i);
#endif
...
static inline void _Salam_g_S_Vector__f64_operator__index__set_i32_f64(Vector__f64* this, int32_t i, double x);
#endif
...
static inline void _Salam_g___intro__f64_Vector__f64_i32_i32_i32(Vector__f64 v, int32_t lo__in, int32_t hi__in, int32_t depth__in);
#endif
...
static inline void _Salam_g___insertion__range__f64_Vector__f64_i32_i32(Vector__f64 v, int32_t lo, int32_t hi);
#endif
...
static inline void _Salam_g___heapsort__range__f64_Vector__f64_i32_i32(Vector__f64 v, int32_t lo, int32_t hi);
#endif
...
static inline int32_t _Salam_g___partition__f64_Vector__f64_i32_i32(Vector__f64 v, int32_t lo, int32_t hi);
#endif
...
static inline void _Salam_g___sift__down__f64_Vector__f64_i32_i32_i32(Vector__f64 v, int32_t lo, int32_t n, int32_t start);
#endif
#ifndef SALAM_IP__Salam_g_Swap__f64_Vector__f64_i32_i32
#define SALAM_IP__Salam_g_Swap__f64_Vector__f64_i32_i32
static inline void _Salam_g_Swap__f64_Vector__f64_i32_i32(Vector__f64 v, int32_t i, int32_t j);
#endif
#ifndef SALAM_IP__Salam_g_swap__f64_Vector__f64_i32_i32
#define SALAM_IP__Salam_g_swap__f64_Vector__f64_i32_i32
static inline void _Salam_g_swap__f64_Vector__f64_i32_i32(Vector__f64 v, int32_t i, int32_t j);
...
static inline void _Salam_g_S_Vector__f64_reserve_i32(Vector__f64* this, int32_t need) {
    ...
    this->data = ((double*)(_Salam_mem_Reallocate_void_ptr_u64(((void*)(this->data)), (((uint64_t)(c)) * (uint64_t)sizeof(double)))));
    this->__cap = c;
}
...
static inline double* _Salam_g_S_Vector__f64_get_i32(Vector__f64* this, int32_t i) {
    ...
    return ((double*)(intptr_t)((((int64_t)(intptr_t)(this->data)) + (((int64_t)(i)) * ((int64_t)((uint64_t)sizeof(double)))))));
}
...
static inline void _Salam_g_clone__f64_Vector__f64(Vector__f64 v, Vector__f64* __ret) {
    ...
    while ((i < _Salam_g_S_Vector__f64_len(&(v)))) {
        _Salam_g_S_Vector__f64_push_f64(&(out), _Salam_g_S_Vector__f64_get_i32(&(v), i)[0]);
        i += 1;
    }
    *__ret = (out); return;
}
        ...
        while (go) {
            if ((j < lo)) {
                ...
                if ((key < _Salam_g_S_Vector__f64_get_i32(&(v), j)[0])) {
                    _Salam_g_S_Vector__f64_set_i32_f64(&(v), (j + 1), _Salam_g_S_Vector__f64_get_i32(&(v), j)[0]);
                    j -= 1;
                } else {
                    go = false;
                }
...
static inline int32_t _Salam_g___partition__f64_Vector__f64_i32_i32(Vector__f64 v, int32_t lo, int32_t hi) {
    ...
    if ((_Salam_g_S_Vector__f64_get_i32(&(v), mid)[0] < _Salam_g_S_Vector__f64_get_i32(&(v), lo)[0])) {
        _Salam_g_Swap__f64_Vector__f64_i32_i32(v, lo, mid);
    }
    if ((_Salam_g_S_Vector__f64_get_i32(&(v), hi)[0] < _Salam_g_S_Vector__f64_get_i32(&(v), lo)[0])) {
        _Salam_g_Swap__f64_Vector__f64_i32_i32(v, lo, hi);
    }
    if ((_Salam_g_S_Vector__f64_get_i32(&(v), hi)[0] < _Salam_g_S_Vector__f64_get_i32(&(v), mid)[0])) {
...
static inline void _Salam_g___sift__down__f64_Vector__f64_i32_i32_i32(Vector__f64 v, int32_t lo, int32_t n, int32_t start) {
    ...
    while (go) {
        ...
        if ((c >= n)) {
            ...
            int32_t big = c;
            if (((c + 1) < n)) {
                if ((_Salam_g_S_Vector__f64_get_i32(&(v), (lo + c))[0] < _Salam_g_S_Vector__f64_get_i32(&(v), ((lo + c) + 1))[0])) {
                    big = (c + 1);
                }
            }
            if ((_Salam_g_S_Vector__f64_get_i32(&(v), (lo + i))[0] < _Salam_g_S_Vector__f64_get_i32(&(v), (lo + big))[0])) {
...
static inline void _Salam_g_swap__f64_Vector__f64_i32_i32(Vector__f64 v, int32_t i, int32_t j) {
    ...
    _Salam_g_S_Vector__f64_set_i32_f64(&(v), i, _Salam_g_S_Vector__f64_get_i32(&(v), j)[0]);
