ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_WIDTH,
                                "STYLE_WIDTH", "style_width", "عرض", "width",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE,
                                ast_layout_allowed_style_width, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_HEIGHT,
                                "STYLE_HEIGHT", "style_height", "ارتفاع",
                                "height",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE,
                                ast_layout_allowed_style_height, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_ACCENT_COLOR,
                                "STYLE_ACCENT_COLOR", "style_accent_color",
                                "رنگ برجسته", "accent-color",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_COLOR, NULL,
                                NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_APPEARANCE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_ASPECT_RATIO,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BACKDROP_FILTER, "STYLE_BACKDROP_FILTER",
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BACKFACE_VISIBILITY,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BLOCK_SIZE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BACKGROUND_IMAGE, "STYLE_BACKGROUND_IMAGE",
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BACKGROUND_CLIP,
                                ...
                                NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BACKGROUND_CLIP, "STYLE_BACKGROUND_CLIP",
    "style_background_clip", "برش پس زمینه", "background-clip",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_background_clip, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BACKGROUND_COLOR, "STYLE_BACKGROUND_COLOR",
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_FLEX_BASIS,
                                "STYLE_FLEX_BASIS", "style_flex_basis",
                                "مبنای انعطاف", "flex-basis",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING_ANY,
                                ast_layout_allowed_style_list_flex_basis, NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_FLEX_BASIS, "STYLE_FLEX_BASIS",
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BACKGROUND_POSITION_X,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BACKGROUND_POSITION_Y,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BACKGROUND_SIZE, "STYLE_BACKGROUND_SIZE",
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_RADIUS,
                                "STYLE_BORDER_RADIUS", "style_border_radius",
                                "گردی", "border-radius",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZES124,
                                NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER,
                                "STYLE_BORDER", "style_border", "مرز", "border",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING_ANY,
                                NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_BLOCK_END_COLOR,
    "STYLE_BORDER_BLOCK_END_COLOR", "style_border_block_end_color",
    "رنگ مرز انتهایی بلوک", "border-block-end-color",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_COLOR, NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_BLOCK_END_STYLE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_BLOCK_END_WIDTH,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_BLOCK_START_COLOR,
    "STYLE_BORDER_BLOCK_START_COLOR", "style_border_block_start_color",
    "رنگ مرز ابتدایی بلوک", "border-block-start-color",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_COLOR, NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_BLOCK_START_STYLE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_BLOCK_START_WIDTH,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_BOTTOM_COLOR,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_BOTTOM_LEFT_RADIUS,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_BOTTOM_RIGHT_RADIUS,
    "STYLE_BORDER_BOTTOM_RIGHT_RADIUS", "style_border_bottom_right_radius",
    "گردی پایین راست", "border-bottom-right-radius",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_BOTTOM_STYLE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_BOTTOM_WIDTH,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_COLLAPSE,
                                ...
                                NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_COLLAPSE, "STYLE_BORDER_COLLAPSE",
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_END_END_RADIUS,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_IMAGE_SLICE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_IMAGE_SOURCE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_IMAGE_WIDTH,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_INLINE_END_COLOR,
    "STYLE_BORDER_INLINE_END_COLOR", "style_border_inline_end_color",
    "رنگ مرز انتهایی خطی", "border-inline-end-color",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_COLOR, NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_INLINE_END_STYLE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_LEFT_STYLE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_LEFT_WIDTH,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_RIGHT_COLOR,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_RIGHT_STYLE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_RIGHT_WIDTH,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BORDER_SPACING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BOX_SIZING, "STYLE_BOX_SIZING",
    "style_box_sizing", "نوع اندازه گیری جعبه", "box-sizing",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_box_sizing, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BOX_SHADOW,
                                "STYLE_BOX_SHADOW", "style_box_shadow",
                                "سایه جعبه", "box-shadow",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING_ANY,
                                NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BREAK_INSIDE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BREAK_BEFORE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_BREAK_AFTER,
                                "STYLE_BREAK_AFTER", "style_break_after",
                                "شکست بعد", "break-after",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_break_after, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CAPTION_SIDE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CARET_COLOR,
                                "STYLE_CARET_COLOR", "style_caret_color",
                                "رنگ نشانگر متنی", "caret-color",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_COLOR, NULL,
                                NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CLEAR,
                                "STYLE_CLEAR", "style_clear",
                                "پاک‌سازی", "clear",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_clear, NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CLEAR,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CLIP_PATH,
                                "STYLE_CLIP_PATH", "style_clip_path",
                                "مسیر برش", "clip-path",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_clip_path, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CLIP_RULE,
                                "STYLE_CLIP_RULE", "style_clip_rule",
                                "قاعده برش", "clip-rule",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_clip_rule, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLOR,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLOR_INTERPOLATION_FILTERS,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLOR_SCHEME,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLUMN_COUNT,
                                ...
                                NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLUMN_COUNT, "STYLE_COLUMN_COUNT",
    "style_column_count", "تعداد ستون ها", "column-count",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_INTEGER,
    ast_layout_allowed_style_list_column_count, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLUMN_FILL,
                                "STYLE_COLUMN_FILL", "style_column_fill",
                                "پر کردن ستون‌ها", "column-fill",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_column_fill, NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLUMN_FILL, "STYLE_COLUMN_FILL",
    "style_column_fill", "پر کردن ستون ها", "column-fill",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_column_fill, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLUMN_GAP,
                                ...
                                NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLUMN_GAP, "STYLE_COLUMN_GAP",
    "style_column_gap", "فاصله بین ستون ها", "column-gap",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLUMN_RULE_COLOR,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLUMN_RULE_STYLE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLUMN_RULE_WIDTH,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLUMN_SPAN,
                                "STYLE_COLUMN_SPAN", "style_column_span",
                                "گستردگی ستون‌ها", "column-span",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_column_span, NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLUMN_SPAN, "STYLE_COLUMN_SPAN",
    "style_column_span", "گستردگی ستون ها", "column-span",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_column_span, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLUMNS,
                                "STYLE_COLUMNS", "style_columns",
                                "ستون‌ها", "columns",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING_ANY,
                                NULL, NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COLUMNS,
                                       "STYLE_COLUMNS", "style_columns",
                                       "ستون ها", "columns",
                                       AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CONTAIN,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CONTAIN_INTRINSIC_BLOCK_SIZE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CONTAIN_INTRINSIC_HEIGHT,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CONTAIN_INTRINSIC_INLINE_SIZE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CONTAIN_INTRINSIC_SIZE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CONTAIN_INTRINSIC_WIDTH,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CONTAINER,
                                "STYLE_CONTAINER", "style_container", "ظرف",
                                "container",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_container, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CONTAINER_NAME,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CONTAINER_TYPE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CONTENT,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CONTENT_VISIBILITY,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COUNTER_INCREMENT,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COUNTER_RESET,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_COUNTER_SET,
                                "STYLE_COUNTER_SET", "style_counter_set",
                                "تنظیم شمارنده", "counter-set",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_INTEGER,
                                ast_layout_allowed_style_list_counter_set, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_CURSOR,
                                "STYLE_CURSOR", "style_cursor", "نشانگر",
                                "cursor",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_cursor, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_DIRECTION,
                                "STYLE_DIRECTION", "style_direction", "جهت",
                                "direction",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_direction, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_DISPLAY,
                                "STYLE_DISPLAY", "style_display", "قرارگیری",
                                "display",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_display, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_DISPLAY,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID,
                                "STYLE_GRID", "style_grid", "شبکه", "grid",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_grid, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_AREA,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_AUTO_COLUMNS,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_AUTO_FLOW,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_AUTO_ROWS,
                                ...
                                NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_AUTO_ROWS, "STYLE_GRID_AUTO_ROWS",
    "style_grid_auto_rows", "ردیف های خودکار شبکه", "grid-auto-rows",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_grid_auto_rows, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_COLUMN,
                                "STYLE_GRID_COLUMN", "style_grid_column",
                                "ستون‌های شبکه", "grid-column",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_grid_column, NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_COLUMN, "STYLE_GRID_COLUMN",
    "style_grid_column", "ستون های شبکه", "grid-column",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_grid_column, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_COLUMN_END,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_COLUMN_START,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_ROW,
                                "STYLE_GRID_ROW", "style_grid_row",
                                "ردیف‌های شبکه", "grid-row",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_grid_row, NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_ROW,
                                       "STYLE_GRID_ROW", "style_grid_row",
                                       "ردیف های شبکه", "grid-row",
                                       AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_ROW_END,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_ROW_START,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_TEMPLATE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_TEMPLATE_AREAS,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_TEMPLATE_COLUMNS,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_GRID_TEMPLATE_ROWS,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_JUSTIFY_CONTENT,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_LEFT,
                                "STYLE_LEFT", "style_left", "چپ", "left",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE,
                                ast_layout_allowed_style_list_left, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_LETTER_SPACING,
                                "STYLE_LETTER_SPACING", "style_letter_spacing",
                                "فاصله بین حروف", "letter-spacing",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING_ANY,
                                NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_LINE_HEIGHT,
                                "STYLE_LINE_HEIGHT", "style_line_height",
                                "ارتفاع خط", "line-height",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING_ANY,
                                NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_LIST_STYLE,
                                "STYLE_LIST_STYLE", "style_list_style",
                                "سبک فهرست", "list-style",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_list_style, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_MARGIN,
                                "STYLE_MARGIN", "style_margin", "فضا", "margin",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZES124,
                                ast_layout_allowed_style_list_margin, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_MARGIN_BOTTOM,
                                ...
                                NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_MARGIN_BOTTOM, "STYLE_MARGIN_BOTTOM",
    "style_margin_bottom", "فضای پایین", "margin-bottom",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE,
    ast_layout_allowed_style_list_margin_bottom, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_MARGIN_LEFT,
                                "STYLE_MARGIN_LEFT", "style_margin_left",
                                "فضا چپ", "margin-left",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE,
                                ast_layout_allowed_style_list_margin_left, NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_MARGIN_LEFT, "STYLE_MARGIN_LEFT",
    "style_margin_left", "فضای چپ", "margin-left",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE,
    ast_layout_allowed_style_list_margin_left, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_MARGIN_RIGHT,
                                ...
                                NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_MARGIN_RIGHT, "STYLE_MARGIN_RIGHT",
    "style_margin_right", "فضای راست", "margin-right",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE,
    ast_layout_allowed_style_list_margin_right, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_MARGIN_TOP,
                                "STYLE_MARGIN_TOP", "style_margin_top",
                                "فضا بالا", "margin-top",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE,
                                ast_layout_allowed_style_list_margin_top, NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_MARGIN_TOP, "STYLE_MARGIN_TOP",
    "style_margin_top", "فضای بالا", "margin-top",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE,
    ast_layout_allowed_style_list_margin_top, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_MAX_HEIGHT,
                                "STYLE_MAX_HEIGHT", "style_max_height",
                                "حداکثر ارتفاع", "max-height",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
                                NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_MAX_WIDTH,
                                "STYLE_MAX_WIDTH", "style_max_width",
                                "حداکثر عرض", "max-width",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
                                NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_MIN_HEIGHT,
                                "STYLE_MIN_HEIGHT", "style_min_height",
                                "حداقل ارتفاع", "min-height",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
                                NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_MIN_WIDTH,
                                "STYLE_MIN_WIDTH", "style_min_width",
                                "حداقل عرض", "min-width",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
                                NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_OBJECT_FIT,
                                "STYLE_OBJECT_FIT", "style_object_fit",
                                "تناسب شیء", "object-fit",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_object_fit, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_OPACITY,
                                "STYLE_OPACITY", "style_opacity", "شفافیت",
                                "opacity",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_PERCENTAGE,
                                NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_OVERFLOW,
                                "STYLE_OVERFLOW", "style_overflow", "بیش از حد",
                                "overflow",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_overflow, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_OVERFLOW_X,
                                "STYLE_OVERFLOW_X", "style_overflow_x",
                                "بیش از حد (X)", "overflow-x",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_overflow_x, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_OVERFLOW_Y,
                                "STYLE_OVERFLOW_Y", "style_overflow_y",
                                "بیش از حد (Y)", "overflow-y",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_overflow_y, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PADDING,
                                "STYLE_PADDING", "style_padding", "فاصله",
                                "padding",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZES124,
                                ast_layout_allowed_style_list_padding, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PADDING_BOTTOM,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PADDING_LEFT,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PADDING_RIGHT,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PADDING_TOP,
                                "STYLE_PADDING_TOP", "style_padding_top",
                                "فاصله بالا", "padding-top",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE,
                                ast_layout_allowed_style_list_padding_top, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TEXT_DECORATION,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TEXT_TRANSFORM,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_VISIBILITY,
                                "STYLE_VISIBILITY", "style_visibility",
                                "قابلیت مشاهده", "visibility",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_visibility, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_Z_INDEX,
                                "STYLE_Z_INDEX", "style_z_index",
                                "الویت موقعیت", "z-index",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_INTEGER,
                                ast_layout_allowed_style_list_z_index, NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_Z_INDEX, "STYLE_Z_INDEX", "style_z_index",
    "ترتیب اولویت", "z-index", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_INTEGER,
    ast_layout_allowed_style_list_z_index, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_OUTLINE_COLOR,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_OUTLINE_OFFSET,
                                "STYLE_OUTLINE_OFFSET", "style_outline_offset",
                                "فاصله حاشیه", "outline-offset",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
                                NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_OUTLINE_STYLE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_OUTLINE_WIDTH,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_OVERFLOW_ANCHOR,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_OVERFLOW_BLOCK,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_OVERFLOW_CLIP_MARGIN,
    "STYLE_OVERFLOW_CLIP_MARGIN", "style_overflow_clip_margin",
    "فاصله برش بیش از حد", "overflow-clip-margin",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_OVERFLOW_INLINE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_OVERFLOW_WRAP,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PADDING_BLOCK,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PADDING_BLOCK_END,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PADDING_BLOCK_START,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PADDING_INLINE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PADDING_INLINE_END,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PADDING_INLINE_START,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PAGE,
                                "STYLE_PAGE", "style_page", "صفحه", "page",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_page, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PAGE_BREAK_AFTER, "STYLE_PAGE_BREAK_AFTER",
    "style_page_break_after", "شکست صفحه بعد از", "page-break-after",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_page_break_after, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PAGE_BREAK_BEFORE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PAGE_BREAK_INSIDE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PAINT_ORDER,
                                "STYLE_PAINT_ORDER", "style_paint_order",
                                "ترتیب نقاشی", "paint-order",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_paint_order, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PERSPECTIVE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PERSPECTIVE_ORIGIN,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PLACE_CONTENT,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PLACE_ITEMS,
                                "STYLE_PLACE_ITEMS", "style_place_items",
                                "موارد مکان", "place-items",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_place_items, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PLACE_SELF,
                                "STYLE_PLACE_SELF", "style_place_self",
                                "خود مکان", "place-self",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_place_self, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_POINTER_EVENTS,
                                ...
                                NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_POINTER_EVENTS, "STYLE_POINTER_EVENTS",
    "style_pointer_events", "رویدادهای اشاره گر", "pointer-events",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_pointer_events, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_POSITION,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_PRINT_COLOR_ADJUST,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_QUOTES,
                                "STYLE_QUOTES", "style_quotes",
                                "نقل‌قول", "quotes",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_quotes, NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_QUOTES,
                                       "STYLE_QUOTES", "style_quotes",
                                       "نقل قول", "quotes",
                                       AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_R, "STYLE_R",
                                "style_r", "شعاع", "r",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
                                NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_RESIZE,
                                "STYLE_RESIZE", "style_resize", "تغییر اندازه",
                                "resize",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_resize, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_RIGHT,
                                "STYLE_RIGHT", "style_right", "راست", "right",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE,
                                ast_layout_allowed_style_list_right, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_ROTATE,
                                "STYLE_ROTATE", "style_rotate", "چرخش",
                                "rotate",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_rotate, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_ROW_GAP,
                                "STYLE_ROW_GAP", "style_row_gap", "فاصله ردیف",
                                "row-gap",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
                                NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_RUBY_ALIGN,
                                "STYLE_RUBY_ALIGN", "style_ruby_align",
                                "هم‌راستایی روبی", "ruby-align",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_ruby_align, NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_RUBY_ALIGN, "STYLE_RUBY_ALIGN",
    "style_ruby_align", "هم راستایی روبی", "ruby-align",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_ruby_align, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_RUBY_POSITION,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_RX, "STYLE_RX",
                                "style_rx", "شعاع X", "rx",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
                                NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_RY, "STYLE_RY",
                                "style_ry", "شعاع Y", "ry",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
                                NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_SCALE,
                                "STYLE_SCALE", "style_scale", "مقیاس", "scale",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING_ANY,
                                NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_SCROLL_BEHAVIOR,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_SCROLL_MARGIN,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_SCROLL_MARGIN_RIGHT,
    "STYLE_SCROLL_MARGIN_RIGHT", "style_scroll_margin_right",
    "فاصله راست پیمایش", "scroll-margin-right",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_SCROLL_MARGIN_TOP,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_SCROLL_PADDING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_SCROLL_PADDING_LEFT,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_SCROLL_PADDING_RIGHT,
    "STYLE_SCROLL_PADDING_RIGHT", "style_scroll_padding_right",
    "فاصله راست پیمایش", "scroll-padding-right",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_SCROLL_PADDING_TOP,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_SCROLL_SNAP_ALIGN,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_SCROLL_SNAP_TYPE, "STYLE_SCROLL_SNAP_TYPE",
    "style_scroll_snap_type", "نوع پیمایش", "scroll-snap-type",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_scroll_snap_type, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_SHAPE_OUTSIDE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TEXT_ALIGN,
                                "STYLE_TEXT_ALIGN", "style_text_align",
                                "تراز متن", "text-align",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_text_align, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TEXT_ALIGN_LAST,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_ALIGN_ITEMS,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TOP,
                                "STYLE_TOP", "style_top", "بالا", "top",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE,
                                ast_layout_allowed_style_list_top, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TRANSFORM,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TRANSFORM_ORIGIN, "STYLE_TRANSFORM_ORIGIN",
    "style_transform_origin", "مرکز تبدیل", "transform-origin",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_transform_origin, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TRANSLATE,
                                "STYLE_TRANSLATE", "style_translate", "ترجمه",
                                "translate",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
                                NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_UNICODE_BIDI,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_USER_SELECT,
                                "STYLE_USER_SELECT", "style_user_select",
                                "انتخاب کاربر", "user-select",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_user_select, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_WILL_CHANGE,
                                "STYLE_WILL_CHANGE", "style_will_change",
                                "تغییر خواهد کرد", "will-change",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_will_change, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TRANSFORM_BOX,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TRANSFORM_STYLE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TRANSITION,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TRANSITION_BEHAVIOR,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TRANSITION_DELAY, "STYLE_TRANSITION_DELAY",
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TRANSITION_DURATION,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TRANSITION_PROPERTY,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_TRANSITION_TIMING_FUNCTION,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_VECTOR_EFFECT,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_VERTICAL_ALIGN,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_WHITE_SPACE,
                                "STYLE_WHITE_SPACE", "style_white_space",
                                "فضای سفید", "white-space",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_white_space, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_WIDOWS,
                                "STYLE_WIDOWS", "style_widows",
                                "بیوه‌ها", "widows",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
                                NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_WIDOWS,
                                       "STYLE_WIDOWS", "style_widows",
                                       "بیوه ها", "widows",
                                       AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE,
                                       NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_WORD_BREAK,
                                "STYLE_WORD_BREAK", "style_word_break",
                                "شکستن کلمه", "word-break",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
                                ast_layout_allowed_style_list_word_break, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_WORD_SPACING,
                                "STYLE_WORD_SPACING", "style_word_spacing",
                                "فاصله کلمه", "word-spacing",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
                                NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_WRITING_MODE,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_STYLE_ZOOM,
