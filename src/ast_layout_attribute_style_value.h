...
const ast_layout_attribute_style_pair_t
...
const ast_layout_attribute_style_pair_t
    ast_layout_allowed_style_list_border_block_start_style[] = {
        {"پیوسته", "solid"},    {"خط‌چین", "dashed"},
        {"خط چین", "dashed"},   {"نقطه‌چین", "dotted"},
...
const ast_layout_attribute_style_pair_t ast_layout_allowed_style_list_clear[] =
    {
        {"هیچ", "none"},   {"چپ", "left"},   {"راست", "right"},
        {"هر دو", "both"}, {"هردو", "both"}, {NULL, NULL},
};
const ast_layout_attribute_style_pair_t
...
const ast_layout_attribute_style_pair_t
    ast_layout_allowed_style_list_align_items[] = {
        {"شروع", "flex-start"}, {"مرکز", "center"},      {"پایان", "flex-end"},
        {"کشش", "stretch"},     {"خط مبنا", "baseline"}, {NULL, NULL},
};
const ast_layout_attribute_style_pair_t
...
const ast_layout_attribute_style_pair_t
    ast_layout_allowed_style_list_font_weight[] = {
        {"عادی", "normal"}, {"معمولی", "normal"},     {"ضخیم", "bold"},
        {"سنگین", "bold"},  {"خیلی سنگین", "bolder"}, {"خیلی ضخیم", "bolder"},
        {NULL, NULL},
};
...
const ast_layout_attribute_style_pair_t
    ast_layout_allowed_style_list_place_content[] = {
        {"فضا", "space-between"}, {"مرکز", "center"}, {"چپ", "start"},
        {"راست", "end"},          {NULL, NULL},
};
const ast_layout_attribute_style_pair_t
...
const ast_layout_attribute_style_pair_t
    ast_layout_allowed_style_list_ruby_position[] = {
        {"بالا", "over"},  {"پایین", "under"}, {"قبل", "before"},
        {"پیش", "before"}, {"بعد", "after"},   {"پس", "after"},
        {NULL, NULL},
};
const ast_layout_attribute_style_pair_t
...
const ast_layout_attribute_style_pair_t
    ast_layout_allowed_style_list_scroll_snap_type[] = {
        {"تک محور", "x"}, {"تک‌محور", "x"}, {"دو محور", "y"},
        {"دومحور", "y"},  {"غیرفعال", "none"},      {NULL, NULL},
};
const ast_layout_attribute_style_pair_t
