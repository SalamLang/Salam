// ADD_LAYOUT_ATTRIBUTE_TYPE(TYPE, NAME, NAME_LOWER, GENERATED_NAME,
// ENDUSER_NAME)
...
ADD_LAYOUT_ATTRIBUTE_TYPE_REPEAT(AST_LAYOUT_ATTRIBUTE_TYPE_DESCRIPTION,
                                 "DESCRIPTION", "description", "description",
                                 "توضیحات")

ADD_LAYOUT_ATTRIBUTE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_KEYWORDS, "KEYWORDS",
                          "keywords", "keywords", "کلمات")
