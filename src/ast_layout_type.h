...
ADD_LAYOUT_TYPE(AST_LAYOUT_TYPE_PARAGRAPH, "PARAGRAPH", "paragraph", "p",
                "پاراگراف", false)
ADD_LAYOUT_TYPE_HIDE(AST_LAYOUT_TYPE_PARAGRAPH_RAW, "PARAGRAPH_RAW",
                     "paragraph_raw", "content", "محتوا", false)
...
ADD_LAYOUT_TYPE(AST_LAYOUT_TYPE_OUTPUT, "OUTPUT", "output", "output", "خروجی",
                false)

ADD_LAYOUT_TYPE(AST_LAYOUT_TYPE_KEYGEN, "KEYGEN", "keygen", "keygen",
                "تولید کلید", false)
...
ADD_LAYOUT_TYPE(AST_LAYOUT_TYPE_SUBTITLE, "SUBTITLE", "subtitle", "subtitle",
                "سرتیتر", false)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_SUBTITLE, "SUBTITLE", "subtitle",
                       "subtitle", "سر تیتر", false)
...
ADD_LAYOUT_TYPE(AST_LAYOUT_TYPE_MARK, "MARK", "mark", "mark", "علامتگذاری",
                false)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_MARK, "MARK", "mark", "mark",
                       "علامت گذاری", false)

ADD_LAYOUT_TYPE(AST_LAYOUT_TYPE_Q, "Q", "q", "q", "نقل قول", false)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_Q, "Q", "q", "q", "نقل‌قول",
                       false)

ADD_LAYOUT_TYPE(AST_LAYOUT_TYPE_CITE, "CITE", "cite", "cite", "اثر", false)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_CITE, "CITE", "cite", "cite", "ارجاع",
                       false)
...
ADD_LAYOUT_TYPE(AST_LAYOUT_TYPE_KBD, "KBD", "kbd", "kbd", "ورودی صفحه نمایش",
                false)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_KBD, "KBD", "kbd", "kbd", "ورودی کیبورد",
                       false)
...
ADD_LAYOUT_TYPE(AST_LAYOUT_TYPE_HGROUP, "HGROUP", "hgroup", "hgroup",
                "گروه سربخش", false)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_HGROUP, "HGROUP", "hgroup", "hgroup",
                       "گروه‌سربخش", false)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_HGROUP, "HGROUP", "hgroup", "hgroup",
                       "گروه‌سر بخش", false)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_HGROUP, "HGROUP", "hgroup", "hgroup",
...
ADD_LAYOUT_TYPE(AST_LAYOUT_TYPE_DETAILS, "DETAILS", "details", "details",
                "جزئیات", false)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_DETAILS, "DETAILS", "details", "details",
                       "جزییات", false)
...
ADD_LAYOUT_TYPE(AST_LAYOUT_TYPE_MENUITEM, "MENUITEM", "menuitem", "menuitem",
                "آیتم منو", false)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_MENUITEM, "MENUITEM", "menuitem",
                       "menuitem", "مورد منو", false)
...
ADD_LAYOUT_TYPE(AST_LAYOUT_TYPE_COLGROUP, "COLGROUP", "colgroup", "colgroup",
                "گروه ستون‌ها", false)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_COLGROUP, "COLGROUP", "colgroup",
                       "colgroup", "گروه ستون‌ ها", false)

// Miscellaneous Elements
ADD_LAYOUT_TYPE(AST_LAYOUT_TYPE_BLOCKQUOTE, "BLOCKQUOTE", "blockquote",
                "blockquote", "نقل قول بلوکی", false)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_BLOCKQUOTE, "BLOCKQUOTE", "blockquote",
                       "blockquote", "نقل‌قول بلوکی", false)

ADD_LAYOUT_TYPE(AST_LAYOUT_TYPE_PRE, "PRE", "pre", "pre",
                "متن پیش‌قالب‌بندی‌شده", false)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_PRE, "PRE", "pre", "pre",
                       "متن پیش‌ قالب‌بندی‌شده", false)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_PRE, "PRE", "pre", "pre",
                       "متن پیش‌ قالب‌ بندی‌شده", false)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_PRE, "PRE", "pre", "pre",
...
ADD_LAYOUT_TYPE(AST_LAYOUT_TYPE_MEDIA, "RESPONSIVE", "responsive", "@media",
                "واکنش گرا", true)
ADD_LAYOUT_TYPE_REPEAT(AST_LAYOUT_TYPE_MEDIA, "RESPONSIVE", "responsive",
