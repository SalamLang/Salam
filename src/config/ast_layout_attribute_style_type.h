...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "backface_visibility", "مشاهده‌پذیری پشت‌نما",
    "backface-visibility", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    ...
    "background-blend-mode", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_background_blend_mode, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "border-block-end-color", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_COLOR, NULL,
    NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_STYLE_TYPE_BORDER_BLOCK_END_STYLE,
    "BORDER_BLOCK_END_STYLE", "border_block_end_style", "سبک مرز انتهایی بلوک",
    "border-block-end-style", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "border-block-end-width", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE,
    ast_layout_allowed_style_list_border_block_end_style, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "border-bottom-left-radius", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
    NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "border-end-start-radius", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
    NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_NUMBER, NULL, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "border-inline-end-color", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_COLOR, NULL,
    NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "border-inline-end-style", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "border-inline-end-width", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
    NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "border-start-end-radius", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
    NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "border-top-left-radius", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_COLOR, NULL,
    NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_STYLE_TYPE_BORDER_TOP_RIGHT_RADIUS,
    "BORDER_TOP_RIGHT_RADIUS", "border_top_right_radius", "گردی بالا راست",
    "border-top-right-radius", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL,
    NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    ...
    "نوع اندازه گیری جعبه", "box-sizing",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_box_sizing, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "color_interpolation", "درهم‌آمیزی رنگ",
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    ...
    "پر کردن ستون ها", "column-fill", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_column_fill, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    ...
    "گستردگی ستون ها", "column-span", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_column_span, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(AST_LAYOUT_ATTRIBUTE_STYLE_TYPE_COLUMNS,
                                "COLUMNS", "columns", "ستون‌ها",
                                "columns",
                                AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING_ANY,
                                NULL, NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_STYLE_TYPE_COLUMNS, "COLUMNS", "columns",
    "ستون‌ ها", "columns", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING_ANY,
    NULL, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "contain-intrinsic-height", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "contain-intrinsic-size", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "contain-intrinsic-width", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    ...
    "سلول های خالی", "empty-cells", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_empty_cells, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "font-feature-settings", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "font-language-override", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "font_optical_sizing", "اندازه‌گیری اپتیکال قلم",
    "font-optical-sizing", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_STYLE_TYPE_FONT_WEIGHT, "FONT_WEIGHT", "font_weight",
    "وزن قلم", "font-weight",
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "grid_auto_columns", "ستون‌های خودکار شبکه",
    "grid-auto-columns", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    ...
    "ستون های شبکه", "grid-column", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_grid_column, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(AST_LAYOUT_ATTRIBUTE_STYLE_TYPE_GRID_ROW,
                                       "GRID_ROW", "grid_row", "ردیف های شبکه",
                                       "grid-row",
                                       AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    ...
    "grid-template-columns", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_grid_template_columns, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_STYLE_TYPE_GRID_TEMPLATE_ROWS, "GRID_TEMPLATE_ROWS",
    "grid_template_rows", "ردیف‌های الگوی شبکه",
    "grid-template-rows", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    ...
    "فضای چپ", "margin-left", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZES124,
    ast_layout_allowed_style_list_margin_left, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    ...
    "فضای بالا", "margin-top", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZES124,
    ast_layout_allowed_style_list_margin_top, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "overflow-clip-margin", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "padding-inline-start", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    ...
    "هم راستایی روبی", "ruby-align", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_ruby_align, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "scroll-margin-bottom", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_STYLE_TYPE_SCROLL_MARGIN_INLINE,
    "SCROLL_MARGIN_INLINE", "scroll_margin_inline", "فاصله درون خطی پیمایش",
    "scroll-margin-inline", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "scroll-padding-block", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "scroll-padding-bottom", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL, NULL)

ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    AST_LAYOUT_ATTRIBUTE_STYLE_TYPE_SCROLL_PADDING_INLINE,
    "SCROLL_PADDING_INLINE", "scroll_padding_inline", "فاصله درون خطی پیمایش",
    "scroll-padding-inline", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE(
    ...
    "scroll-padding-right", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE, NULL, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_STYLE_TYPE_ALIGN_ITEMS, "ALIGN_ITEMS", "align_items",
    "تراز‌کردن‌ محتوا", "align-items",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_align_items, NULL)
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    AST_LAYOUT_ATTRIBUTE_STYLE_TYPE_ALIGN_ITEMS, "ALIGN_ITEMS", "align_items",
    "تراز محتوا", "align-items", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING,
    ast_layout_allowed_style_list_align_items, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_REPEAT(
    ...
    "تو رفتگی متن", "text-indent", AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_SIZE,
    ast_layout_allowed_style_list_text_indent, NULL)
...
ADD_LAYOUT_ATTRIBUTE_STYLE_TYPE_HIDE(
    AST_LAYOUT_ATTRIBUTE_TYPE_ERROR, "AST_LAYOUT_ATTRIBUTE_TYPE_ERROR",
    "ast_layout_attribute_type_error", "", "ast_layout_attribute_type_error",
    AST_LAYOUY_ATTRIBUTE_STYLE_FILTER_STRING_ANY, NULL, NULL)
