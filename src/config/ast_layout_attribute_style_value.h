...
const ast_layout_attribute_style_pair_t size_default[] = {
    {"خودکار", "auto"},
...
const ast_layout_attribute_style_pair_t
    ast_layout_allowed_style_list_border_image_repeat[] = {
        ...
        {"تکرار عمودی", "repeat-y"}, {"بدون‌تکرار", "no-repeat"},
...
const ast_layout_attribute_style_pair_t
    ast_layout_allowed_style_list_list_style[] = {
        {"پوشش", "cover"},      {"نشان‌دهنده", "disc"},
        {"نشان دهنده", "disc"}, {"دایره‌ای", "circle"},
...
const ast_layout_attribute_style_pair_t
    ast_layout_allowed_style_list_ruby_position[] = {
        {"بالا", "over"}, {"روی", "over"},   {"پایین", "under"},
        {"زیر", "under"}, {"قبل", "before"}, {"پیش", "before"},
        {"بعد", "after"}, {"پس", "after"},   {NULL, NULL},
};
...
const ast_layout_attribute_style_pair_t
    ast_layout_allowed_style_list_text_align_last[] = {
        ...
        {"تراز بندی", "justify"}, {"تراز‌بندی", "justify"},
