...
ADD_LAYOUT_ATTRIBUTE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_DOWNLOAD, "DOWNLOAD",
                          "download", "دانلود", "download",
                          AST_LAYOUT_ATTRIBUTE_FILTER_STRING_ANY, NULL, NULL,
                          AST_LAYOUT_ATTRIBUTE_VALUE_HANDLER_SIMPLE)
ADD_LAYOUT_ATTRIBUTE_TYPE_REPEAT(AST_LAYOUT_ATTRIBUTE_TYPE_DOWNLOAD, "DOWNLOAD",
                                 "download", "بارگیری", "download",
                                 AST_LAYOUT_ATTRIBUTE_FILTER_STRING_ANY, NULL,
                                 NULL,
                                 AST_LAYOUT_ATTRIBUTE_VALUE_HANDLER_SIMPLE)

ADD_LAYOUT_ATTRIBUTE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_SRC_HREF, "SRC_HREF",
                          "src_href", "منبع", "href",
                          AST_LAYOUT_ATTRIBUTE_FILTER_STRING_ANY, NULL, NULL,
                          AST_LAYOUT_ATTRIBUTE_VALUE_HANDLER_SIMPLE)

ADD_LAYOUT_ATTRIBUTE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_LANGUAGE, "LANGUAGE",
                          "language", "زبان", "hreflang",
                          AST_LAYOUT_ATTRIBUTE_FILTER_STRING_ANY, NULL, NULL,
                          AST_LAYOUT_ATTRIBUTE_VALUE_HANDLER_SIMPLE)

ADD_LAYOUT_ATTRIBUTE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_MEDIA, "MEDIA", "media",
                          "رسانه", "media",
                          AST_LAYOUT_ATTRIBUTE_FILTER_STRING_ANY, NULL, NULL,
                          AST_LAYOUT_ATTRIBUTE_VALUE_HANDLER_SIMPLE)

ADD_LAYOUT_ATTRIBUTE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_PING, "PING", "ping",
                          "پینگ", "ping",
                          AST_LAYOUT_ATTRIBUTE_FILTER_STRING_ANY, NULL, NULL,
                          AST_LAYOUT_ATTRIBUTE_VALUE_HANDLER_SIMPLE)

ADD_LAYOUT_ATTRIBUTE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_REFERRER_POLICY,
                          "REFERRER_POLICY", "referrer_policy", "سیاست ارجاع",
                          "referrerpolicy", AST_LAYOUT_ATTRIBUTE_FILTER_STRING,
                          ast_layout_allowed_referrerpolicy, NULL,
                          AST_LAYOUT_ATTRIBUTE_VALUE_HANDLER_SIMPLE)

ADD_LAYOUT_ATTRIBUTE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_REL, "REL", "rel", "رابطه",
                          "rel", AST_LAYOUT_ATTRIBUTE_FILTER_STRING,
                          ast_layout_allowed_rel, NULL,
                          AST_LAYOUT_ATTRIBUTE_VALUE_HANDLER_SIMPLE)

ADD_LAYOUT_ATTRIBUTE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_TARGET, "TARGET", "target",
                          "هدف", "target", AST_LAYOUT_ATTRIBUTE_FILTER_STRING,
