...
ADD_LAYOUT_ATTRIBUTE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_WIDTH, "WIDTH", "width", "طول", "width", AST_LAYOUT_ATTRIBUTE_FILTER_SIZE, NULL, NULL, AST_LAYOUT_ATTRIBUTE_VALUE_HANDLER_SIMPLE)

ADD_LAYOUT_ATTRIBUTE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_HEIGHT, "HEIGHT", "height", "ارتفاع", "height", AST_LAYOUT_ATTRIBUTE_FILTER_SIZE, NULL, NULL, AST_LAYOUT_ATTRIBUTE_VALUE_HANDLER_SIMPLE)
ADD_LAYOUT_ATTRIBUTE_TYPE_REPEAT(AST_LAYOUT_ATTRIBUTE_TYPE_HEIGHT, "HEIGHT", "height", "عرض", "height", AST_LAYOUT_ATTRIBUTE_FILTER_SIZE, NULL, NULL, AST_LAYOUT_ATTRIBUTE_VALUE_HANDLER_SIMPLE)
...
ADD_LAYOUT_ATTRIBUTE_TYPE(AST_LAYOUT_ATTRIBUTE_TYPE_CONTROLS, "CONTROLS", "controls", "کنترل ها", "controls", AST_LAYOUT_ATTRIBUTE_FILTER_STRING_ANY, NULL, NULL, AST_LAYOUT_ATTRIBUTE_VALUE_HANDLER_SIMPLE)
ADD_LAYOUT_ATTRIBUTE_TYPE_REPEAT(AST_LAYOUT_ATTRIBUTE_TYPE_CONTROLS, "CONTROLS", "controls", "کنترل‌ها", "controls", AST_LAYOUT_ATTRIBUTE_FILTER_STRING_ANY, NULL, NULL, AST_LAYOUT_ATTRIBUTE_VALUE_HANDLER_SIMPLE)
