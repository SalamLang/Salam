// ----------- BEGIN AUTO GENERATED ----------- //
    ...
    if (is_attribute_type_in_array(attribute_key_type, valid_attributes_img, valid_attributes_img_length)) {
        return true;
    }
}
else if (attribute->parent_node_type == AST_LAYOUT_TYPE_SCRIPT) {
    if (is_attribute_type_in_array(attribute_key_type, valid_attributes_script, valid_attributes_script_length)) {
        return true;
    }
}
