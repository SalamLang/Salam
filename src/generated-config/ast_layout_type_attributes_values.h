...
ast_layout_attribute_type_t valid_attributes_script[] = {
    AST_LAYOUT_ATTRIBUTE_TYPE_SRC,
};
const size_t valid_attributes_script_length = sizeof(valid_attributes_script) / sizeof(valid_attributes_script[0]);
