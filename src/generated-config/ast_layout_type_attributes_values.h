...
ast_layout_attribute_type_t valid_attributes_layout[] = {
    AST_LAYOUT_ATTRIBUTE_TYPE_TITLE,       AST_LAYOUT_ATTRIBUTE_TYPE_LANG,
    AST_LAYOUT_ATTRIBUTE_TYPE_DIR,         AST_LAYOUT_ATTRIBUTE_TYPE_AUTHOR,
    AST_LAYOUT_ATTRIBUTE_TYPE_DESCRIPTION, AST_LAYOUT_ATTRIBUTE_TYPE_KEYWORDS,
    AST_LAYOUT_ATTRIBUTE_TYPE_ICON,        AST_LAYOUT_ATTRIBUTE_TYPE_CHARSET,
    AST_LAYOUT_ATTRIBUTE_TYPE_REFRESH,     AST_LAYOUT_ATTRIBUTE_TYPE_VIEWPORT,
};
