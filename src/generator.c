...
void generator_save(generator_t *generator, const char *html_output,
    ...
    if (generator == NULL) {
        ...
        if (generator->css != NULL) {
			...
			size_t content_length = generator->css->length + generator->media_css->length;
        ...
        if (generator->js != NULL) {
            ...
            string_append_str(js_output_file, js_output);
...
string_t *generator_code_node(generator_t *generator, ast_node_t *node) {
    ...
    switch (node->type) {
        ...
        case AST_TYPE_BLOCK: {
            string_t *block_code =
                generator_code_block(generator, node->data.block);
        ...
        case AST_TYPE_FUNCTION: {
            string_t *function_code =
                generator_code_function(generator, node->data.function);
        ...
        case AST_TYPE_ELSE_IF: {
            string_t *if_code =
                generator_code_if(generator, node->data.ifclause);
        ...
        case AST_TYPE_RETURN: {
            string_t *return_code =
                generator_code_return(generator, node->data.returns);
        ...
        case AST_TYPE_PRINT: {
            string_t *print_code =
                generator_code_print(generator, node->data.print);
...
string_t *generator_code_print(generator_t *generator, ast_print_t *print) {
    ...
    if (values_code == NULL) {
        error_generator(
            2, "Error generating code for print values in print statement");
    }
...
string_t *generator_code_return(generator_t *generator, ast_return_t *returns) {
    ...
    if (returns->values->length == 0) {
        ...
        string_t *values_code =
            generator_code_values(generator, returns->values);

        if (values_code == NULL) {
            error_generator(
                2,
                "Error generating code for return values in return statement");
        }
...
string_t *generator_code_if(generator_t *generator, ast_if_t *ifclause) {
    ...
    if (ifclause->condition != NULL) {
        string_t *condition_code =
            generator_code_value(generator, ifclause->condition);
...
void generator_code_functions(generator_t *generator) {
    DEBUG_ME;
    if (generator != NULL && generator->ast != NULL &&
        generator->ast->functions != NULL &&
        generator->ast->functions->data != NULL &&
        generator->ast->functions->length > 0) {
        for (size_t i = 0; i < generator->ast->functions->length; i++) {
            ast_function_t *function = array_get(generator->ast->functions, i);

            if (function != NULL) {
                string_t *function_code =
                    generator_code_function(generator, function);
