...
gcc  -o main.exe log.win.o file.win.o memory.win.o array.win.o parser.win.o generator.win.o generator_layout.win.o generator_identifier.win.o string.win.o validator.win.o hashmap.win.o lexer.win.o ast.win.o ast_layout.win.o main.win.o
