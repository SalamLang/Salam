...
char* ast_type_name(ast_type_type_t type)
{
    switch (type) {
        ...
        case AST_KIND_TYPE_MAP: return "TYPE_MAP";
        case AST_KIND_TYPE_SET: return "TYPE_SET";
        case AST_KIND_TYPE_TUPLE: return "TYPE_TUPLE";
        case AST_KIND_TYPE_VOID: return "TYPE_VOID";
        case AST_KIND_TYPE_ANY: return "TYPE_ANY";
        case AST_KIND_TYPE_USER_DEFINED: return "TYPE_USER_DEFINED";
    }
    return "TYPE_UNKNOWN";
}
