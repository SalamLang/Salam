...
ast_t* ast_program_create(array_t* variable_declarations, array_t* function_declarations, size_t variable_declaration_count, size_t function_declaration_count)
{
    ...
    ast_layout_t* ast_layout = ast_layout_create();

    ast->raw.program_value.layout = ast_layout;
    ...
    ast->raw.program_value.variable_declaration_count = variable_declaration_count;
    ast->raw.program_value.function_declaration_count = function_declaration_count;
    return ast;
}
