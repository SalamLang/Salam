...
typedef struct {
    ...
    ast_t*
        value;  // ast_t*(ast_extern_function_t) or ast_t(ast_extern_variable_t)
} ast_extern_decl_t;
...
typedef struct {
    char* name;
    ast_t* parameters;  // ast_t*(ast_parameters_t) (type, name, and optional
                        // default value)
...
typedef struct {
    ...
    char* alias;  // (nullable)
    hashmap_t*
        values;  // key is string, value is optional ast_expression_item_t
} ast_kind_enum_t;
...
typedef struct {
    ...
    ast_t* value;  // ast_t*(ast_kind_struct_t), or ast_t(ast_kind_enum_t), or
                   // ast_t(ast_kind_union_t)
} ast_kind_decl_t;
...
typedef struct {
    ast_t* initializer;  // ast_t*(ast_variable_decl_t) or
                         // ast_t(ast_statement_expression_t) (nullable)
    ast_t* condition;    // ast_t*(ast_expression_item_t) (nullable)
...
typedef struct ast_t {
    ...
    union {
        ...
        // parameters - a list of pairs of name, type, and optional default
        // value
