#ifndef _SRC_STAGE_PARSER_PARSER_OPERATOR_EXPECT_PARSER_OPERATOR_EXPECT_H_
#define _SRC_STAGE_PARSER_PARSER_OPERATOR_EXPECT_PARSER_OPERATOR_EXPECT_H_
...
#endif // _SRC_STAGE_PARSER_PARSER_OPERATOR_EXPECT_PARSER_OPERATOR_EXPECT_H_
