#ifndef _STAGE_PARSER_PARSER_PARSE_FUNCTION_DECL_PARSER_PARSE_FUNCTION_DECL_H_
#define _STAGE_PARSER_PARSER_PARSE_FUNCTION_DECL_PARSER_PARSE_FUNCTION_DECL_H_
