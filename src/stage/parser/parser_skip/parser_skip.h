#ifndef _SRC_STAGE_PARSER_PARSER_SKIP_PARSER_SKIP_H_
#define _SRC_STAGE_PARSER_PARSER_SKIP_PARSER_SKIP_H_
...
#endif // _SRC_STAGE_PARSER_PARSER_SKIP_PARSER_SKIP_H_
