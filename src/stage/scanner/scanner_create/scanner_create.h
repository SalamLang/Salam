#ifndef _SRC_STAGE_SCANNER_SCANNER_CREATE_SCANNER_CREATE_H_
#define _SRC_STAGE_SCANNER_SCANNER_CREATE_SCANNER_CREATE_H_
...
#endif // _SRC_STAGE_SCANNER_SCANNER_CREATE_SCANNER_CREATE_H_
