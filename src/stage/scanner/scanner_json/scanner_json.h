#ifndef _SRC_STAGE_SCANNER_SCANNER_JSON_SCANNER_JSON_H_
#define _SRC_STAGE_SCANNER_SCANNER_JSON_SCANNER_JSON_H_
...
#endif // _SRC_STAGE_SCANNER_SCANNER_JSON_SCANNER_JSON_H_
