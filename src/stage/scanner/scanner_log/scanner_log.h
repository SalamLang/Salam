#ifndef _SRC_STAGE_SCANNER_SCANNER_LOG_SCANNER_LOG_H_
#define _SRC_STAGE_SCANNER_SCANNER_LOG_SCANNER_LOG_H_
...
#endif // _SRC_STAGE_SCANNER_SCANNER_LOG_SCANNER_LOG_H_
