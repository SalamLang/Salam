#ifndef _SRC_STAGE_SCANNER_SCANNER_SCAN_SCANNER_SCAN_H_
#define _SRC_STAGE_SCANNER_SCANNER_SCAN_SCANNER_SCAN_H_
...
#endif // _SRC_STAGE_SCANNER_SCANNER_SCAN_SCANNER_SCAN_H_
