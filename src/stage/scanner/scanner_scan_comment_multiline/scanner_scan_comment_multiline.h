#ifndef _STAGE_SCANNER_SCANNER_SCAN_COMMENT_MULTILINE_SCANNER_SCAN_COMMENT_MULTILINE_H_
#define _STAGE_SCANNER_SCANNER_SCAN_COMMENT_MULTILINE_SCANNER_SCAN_COMMENT_MULTILINE_H_
