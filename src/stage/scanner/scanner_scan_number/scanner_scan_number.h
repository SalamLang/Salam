#ifndef _SRC_STAGE_SCANNER_SCANNER_SCAN_NUMBER_SCANNER_SCAN_NUMBER_H_
#define _SRC_STAGE_SCANNER_SCANNER_SCAN_NUMBER_SCANNER_SCAN_NUMBER_H_
...
#endif // _SRC_STAGE_SCANNER_SCANNER_SCAN_NUMBER_SCANNER_SCAN_NUMBER_H_
