#ifndef _SRC_STAGE_SCANNER_SCANNER_SCAN_STRING_SCANNER_SCAN_STRING_H_
#define _SRC_STAGE_SCANNER_SCANNER_SCAN_STRING_SCANNER_SCAN_STRING_H_
...
#endif // _SRC_STAGE_SCANNER_SCANNER_SCAN_STRING_SCANNER_SCAN_STRING_H_
