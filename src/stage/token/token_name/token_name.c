...
const char* token_name(token_type_t type) {
    switch (type) {
        ...
        // value
        case TOKEN_TYPE_VALUE_STRING:
            return "STRING";
        case TOKEN_TYPE_VALUE_NUMBER_INT:
            return "NUMBER_INT";
        case TOKEN_TYPE_VALUE_NUMBER_FLOAT:
            return "NUMBER_FLOAT";
        case TOKEN_TYPE_VALUE_TRUE:
            return "TRUE";
        case TOKEN_TYPE_VALUE_FALSE:
            return "FALSE";
        case TOKEN_TYPE_VALUE_NULL:
            return "NULL";
    }
