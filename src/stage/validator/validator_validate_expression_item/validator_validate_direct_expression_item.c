            ...
            switch (expression_item.raw.literal.value->type) {
                ...
                default:
                    log_fatal(
                        ...
                        "validator_validate_direct_expression_item: %d\n",
                        expression_item.raw.literal.value->type);
                    break;
            }
            expression_item.raw.literal.runtime_type =
                ast_type_exact_create_primitive(type, false, false, false);
            expression_item.runtime_type =
                ast_type_exact_create_primitive(type, false, false, false);
            break;

        case AST_EXPRESSION_TYPE_IDENTIFIER:
            expression_item.raw.identifier.runtime_type =
                ast_type_exact_create_primitive(AST_KIND_TYPE_INT, false, false,
                                                false);
            expression_item.runtime_type = ast_type_exact_create_primitive(
                AST_KIND_TYPE_INT, false, false, false);
            break;

        case AST_EXPRESSION_TYPE_BINARY:
            expression_item.runtime_type =
                expression_item.raw.binary.runtime_type;
            break;

        case AST_EXPRESSION_TYPE_UNARY:
            expression_item.runtime_type =
                expression_item.raw.unary.runtime_type;
            break;

        case AST_EXPRESSION_TYPE_INDEX:
            expression_item.runtime_type =
                expression_item.raw.index.runtime_type;
            break;

        case AST_EXPRESSION_TYPE_CALL:
            expression_item.runtime_type =
                expression_item.raw.call.runtime_type;
            break;
    }
