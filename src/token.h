...
ADD_KEYWORD(TOKEN_IMPORT, "IMPORT", "import", 7)
ADD_KEYWORD(TOKEN_FUNCTION, "FUNCTION", "fn", 8)
ADD_KEYWORD(TOKEN_RETURN, "RETURN", "return", 7)
...
ADD_KEYWORD(TOKEN_CONTINUE, "CONTINUE", "continue", 10)
ADD_KEYWORD(TOKEN_BOOLEAN, "BOOLEAN", "true", 7)
ADD_KEYWORD_HIDE(TOKEN_BOOLEAN, "BOOLEAN", "false", 7)
