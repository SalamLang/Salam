...
ADD_KEYWORD(TOKEN_BLOCK_CLOSE, "BLOCK_CLOSE", "تمام", 8)

// ADD_KEYWORD(TOKEN_LAYOUT, "LAYOUT", "layout", 6)
ADD_KEYWORD(TOKEN_LAYOUT, "LAYOUT", "صفحه", 8)
// ADD_KEYWORD(TOKEN_IMPORT, "IMPORT", "import", 6)
ADD_KEYWORD(TOKEN_FUNCTION, "FUNCTION", "تابع", 8)
// ADD_KEYWORD(TOKEN_FUNCTION, "FUNCTION", "fn", 2)
ADD_KEYWORD(TOKEN_RETURN, "RETURN", "برگشت", 10)
// ADD_KEYWORD(TOKEN_RETURN, "RETURN", "ret", 3)
ADD_KEYWORD(TOKEN_IF, "IF", "اگر", 6)
// ADD_KEYWORD(TOKEN_IF, "IF", "if", 2)
// ADD_KEYWORD(TOKEN_PRINT, "PRINT", "print", 5)
ADD_KEYWORD(TOKEN_PRINT, "PRINT", "نمایش", 10)
