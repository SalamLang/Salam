...
SCV_API cv_mat_t *scv_new_blank(int32_t width, int32_t height, int32_t channels, int32_t r,
                                 int32_t g, int32_t b);
...
// -- geometry ----------------------------------------------------------
SCV_API cv_mat_t *scv_resize(cv_mat_t *mat, int32_t width, int32_t height, int32_t interpolation);
...
SCV_API cv_mat_t *scv_threshold(cv_mat_t *mat, double thresh, double maxval, int32_t kind);
...
SCV_API int32_t scv_line(cv_mat_t *mat, int32_t x1, int32_t y1, int32_t x2, int32_t y2, int32_t r,
...
SCV_API int32_t scv_circle(cv_mat_t *mat, int32_t cx, int32_t cy, int32_t radius, int32_t r,
                            int32_t g, int32_t b, int32_t thickness);
SCV_API int32_t scv_put_text(cv_mat_t *mat, const char *text, int32_t x, int32_t y,
                              ...
                              int32_t thickness);
SCV_API int32_t scv_ellipse(cv_mat_t *mat, int32_t cx, int32_t cy, int32_t axis_w, int32_t axis_h,
                             double angle, int32_t r, int32_t g, int32_t b, int32_t thickness);
SCV_API int32_t scv_polylines(cv_mat_t *mat, const int32_t *pts_xy, int32_t count, int32_t closed,
                               int32_t r, int32_t g, int32_t b, int32_t thickness);
SCV_API int32_t scv_fill_poly(cv_mat_t *mat, const int32_t *pts_xy, int32_t count, int32_t r,
                               int32_t g, int32_t b);
...
// -- arithmetic / blending ---------------------------------------------------
SCV_API cv_mat_t *scv_add_weighted(cv_mat_t *mat1, double alpha, cv_mat_t *mat2, double beta,
                                    double gamma);
...
SCV_API cv_mat_t *scv_warp_perspective_quad(cv_mat_t *mat, const double *src_xy /* [8] */,
                                             const double *dst_xy /* [8] */, int32_t out_width,
                                             int32_t out_height);
SCV_API int32_t scv_match_template(cv_mat_t *mat, cv_mat_t *tmpl, int32_t *out_x, int32_t *out_y,
                                    double *out_score);
...
SCV_API int32_t scv_contour_bounding_rect(cv_contours_t *cs, int32_t idx, int32_t *out_xywh);
...
SCV_API int32_t scv_keypoint_get(cv_keypoints_t *kp, int32_t idx, double *out_xy /* [5] */);
...
SCV_API int32_t scv_match_get(cv_matches_t *m, int32_t idx, int32_t *out_query, int32_t *out_train,
                               double *out_dist);
...
SCV_API int32_t scv_dnn_set_input(cv_net_t *net, cv_mat_t *mat, double scale, double mean_r,
