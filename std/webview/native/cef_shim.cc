...
{
  public:
    ShimWindowDelegate(CefRefPtr<CefBrowserView> view, int width, int height, bool fixed)
...
extern "C" void salam_wv_cef_set_size(void *view, int width, int height, int fixed)
{
    View *v = AsView(view);
